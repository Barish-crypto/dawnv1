...
class Dawn:
    ...
    async def user_data(self, app_id: str, email: str, token: str, proxy=None, retries=5):
        url = f"{self.BASE_API}/api/atom/v1/userreferral/getpoint?appid=67ef56610b8e12491ab70ad8"
        headers = {
            **self.headers,
    ...
    async def send_keepalive(self, app_id: str, email: str, token: str, use_proxy: bool, proxy=None, retries=5):
        url = f"{self.BASE_API}/chromeapi/dawn/v1/userreward/keepalive?appid=67ef56610b8e12491ab70ad8"
